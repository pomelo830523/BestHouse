...
export class FilterRulesComponent implements OnInit {
  ...
  readonly ruleTypes: FilterRuleType[] = [
    ...
    'MIN_INDOOR_PING', 'MIN_FLOOR', 'MAX_FLOOR', 'EXCLUDE_PARKING_TYPE', 'MIN_PARKING_PING',
  ...
  readonly numValueTypes: FilterRuleType[] = [
    'MAX_TOTAL_PRICE', 'MAX_PRICE_PER_PING', 'MAX_HOUSE_AGE', 'MIN_INDOOR_PING', 'MIN_FLOOR', 'MAX_FLOOR', 'MIN_PARKING_PING',
    'MAX_HOUSEHOLD_PER_ELEVATOR_RATIO',
    'MAX_WALK_METERS_TO_HSR_ZHUBEI', 'MAX_WALK_METERS_TO_FENGYUAN',
    'MAX_WALK_METERS_TO_ELEMENTARY', 'MAX_WALK_METERS_TO_JUNIOR_HIGH',
  ];
